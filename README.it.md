...
> In inglese ([docs/en/](docs/en/)): ARCHITECTURE, INSTALL, UPDATE, BACKUP-RESTORE, CLI, MEMORIA-1777, ARCHIVE, RICERCA-IBRIDA — freschezza garantita da `tools/tests/test_traduzioni_fresche.py`.
