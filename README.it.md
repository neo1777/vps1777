...
| **archive-mcp** | Ricerca FTS5 su più DB (export web claude.ai, sessioni Claude Code) e ricerca ibrida per senso, FTS5 + vettori ([docs/RICERCA-IBRIDA.md](docs/RICERCA-IBRIDA.md)) | 8002 |
...
> In inglese ([docs/en/](docs/en/)): ARCHITECTURE, INSTALL, UPDATE, BACKUP-RESTORE, CLI, MEMORIA-1777, RICERCA-IBRIDA — freschezza garantita da `tools/tests/test_traduzioni_fresche.py`.
