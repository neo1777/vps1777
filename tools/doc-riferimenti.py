...
ATTESI = {
    ...
    "tokenizer.json": "artefatto del modello di embedding (ricerca ibrida, #281): si "
        "genera sul PC e vive nel volume archive, /var/lib/archive/models/ — fuori dal "
        "repo per costruzione, come i DB e gli indici. docs/RICERCA-IBRIDA.md spiega "
        "come produrlo: è una ISTRUZIONE, non un link a un file versionato",
